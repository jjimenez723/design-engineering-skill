...
description: Build or review polished web interfaces using Emil Kowalski's design-engineering approach. Use for UI hierarchy, layout, forms, component craft, interaction feedback, animation decisions, and the subtle details that make software feel coherent. For a motion-only audit use review-animations; for Apple-specific fluid interaction principles use apple-design.
---
...
For non-trivial UI construction or review, read [references/ui-ux-foundations.md](references/ui-ux-foundations.md). Apply it before visual polish or motion so scanning, grouping, alignment, contrast, state communication, and form ergonomics are correct first.
